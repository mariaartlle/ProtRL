...
if __name__=='__main__':
    ...
    tokenizer = AutoTokenizer.from_pretrained("/home/woody/b114cb/b114cb23/models/ZymCTRL") # change to ZymCTRL location
    ...
    for label in tqdm(labels):
        ...
        fn = open(f"/home/woody/b114cb/b114cb23/Filippo/Q4_2024/DPO/DPO_Clean/CLEAN/app/data/inputs/seq_gen_{label}_iteration{iteration_num}.fasta", "w")
