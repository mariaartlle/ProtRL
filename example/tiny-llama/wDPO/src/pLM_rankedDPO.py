...
class ranked_DPO(GRPOTrainer):
    ...
    def _compute_loss(self, model, inputs):
            ...
            advantages, sorted_indices = advantages.sort(descending=True)
            print("advantage 2", advantages)
            ...
            uniform_weights = torch.arange(advantages.size(0) -1 , -1, -1, device=advantages.device, dtype=advantages.dtype)
