...
model_directory="/home/woody/b114cb/b114cb23/Filippo/Q4_2024/DPO_binder_FT_EGFv2_zymctrl/output_iteration0" # put the path to your local model or a Huggingface's repository (to be called with transformer's API)
